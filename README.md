...
```text
main.tex     # the manuscript (EPJC / sn-jnl)
main.pdf     # compiled output (pdflatex x2)
...
scientific magnitude from `main.tex` (a `x 10^b` in any notation
...
1. Write the number into `main.tex`.
...
Every quantitative claim in `main.tex` is registered exactly once
