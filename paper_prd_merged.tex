...
\label{eq:D5}
\end{equation}
where $\rho_{\rm DM}^{(0)}=\Omega_{\rm DM}\rho_{\rm crit}^{(0)}\approx9.7\times10^{-48}\,$GeV$^4$ and $T_0\approx2.36\times10^{-13}\,$GeV. For $T_{\rm reh}\in[10^{-2},10^{15}]\,$GeV this gives $\rho_{\rm cond}(a_{\rm reh})<(5.2\times10^{-16}\text{--}5.2\times10^{35})\,$GeV$^4$. Comparing with the initial condensate energy density $\rho_{\rm cond}(a_{\rm end})\sim\frac12 m_\chi^2\MP^2\simeq3\times10^{63}\,$GeV$^4$, the required suppression factor is $\sim2\times10^{26}$--$2\times10^{77}$ (the upper end corresponding to $T_{\rm reh}$ at the BBN floor). This suppression is supplied by the decay of the condensate (channel (iv) of Sec.~IV): because $\Gamma t_0\gg1$ for any $T_{\rm reh}\gtrsim10^{-2}\,$GeV, the residual condensate at $a_0$ is strictly zero (D5c), and the locked $N$ is confined to the Planck-compatible band (anomaly $T_{\rm reh}\sim10^9\,$GeV $\Rightarrow$ $N\simeq50.7$).
